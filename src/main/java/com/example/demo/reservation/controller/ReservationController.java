...
public class ReservationController {
	    ...
	    public void createReservationInformation(@RequestBody Map<String, String> data) {
	    	reservationService.insertResrvationInfo(data);
	    }
	    ...
	    @ResponseBody
	    public List<Map<String, String>> getReservationInventoryList(@RequestParam Map<String, String> data) {
