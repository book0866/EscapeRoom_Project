...
//	회원 id 랜덤 적용 이후 삭제 해야됨
	...
	boolean existsByMemberAndThemeAndSpotName(Member member, Theme theme, Spot spot);
	 ...
	 @Query("SELECT r.no as no, r.member.name as name, r.theme.theme as theme, r.spotName.spotName as spot, "
	            + "r.reservationDate as reservationDate, r.people as people "
	            + "FROM Reservation r WHERE r.spotName.spotName = :spot")
