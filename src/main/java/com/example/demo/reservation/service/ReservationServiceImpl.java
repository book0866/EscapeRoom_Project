...
public class ReservationServiceImpl implements ReservationService {
	 ...
	 */
	@Override
	public void insertResrvationInfo(Map<String, String> data) {
		/* 확인 */
		...
		// 무작위 회원 가져오기
	    Member randomMember = memberRepository.findRandomMember();
	    String member_id = randomMember != null ? randomMember.getId() : "testUser1"; // 무작위로 가져온 회원 ID를 사용하고, 없으면 기본값 사용
